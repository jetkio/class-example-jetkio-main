/*
    ...
    Description: file defines the grammar and evaluation logic. makes the operator 
    precedence and associativity for arithmetic, comparison, and logical operators, 
    and does the calculations and variable assignments.
*/
...
%right '='              /* Lowest: Assignment */
%left '&' '|'           /* New: Logical AND / OR */
%left EQ                /* New: Equality (==) */
%left '<' '>'           /* New: Comparison */
%left '-' '+'
%left '*' '/'
%nonassoc UMINUS        /* Highest: Unary Minus */
